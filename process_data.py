...
tree = 'FloatingpointThreshold0DussmmyHistomaxDummynTuple/HGCalTriggerNtuple'

all_files = get_rootfiles_local('/mnt/scratch/eertorer/ECONAE/data')[:args.num_files]
...
for m in all_models:
    ...
    indir='/mnt/scratch/eertorer/ECONAE/data'
    absolute_paths = [os.path.join(indir, item) for item in os.listdir(indir)]
    process_data(absolute_paths[:args.num_files], args.save_every_n_files, model_info=m, model_dir = model_dir)
